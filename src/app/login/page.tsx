...
import { Eye, EyeOff, TrendingUp, Lock, User, AlertCircle, Loader2 } from 'lucide-react'
    ...
    <div className="min-h-screen flex items-center justify-center bg-background p-4 relative overflow-hidden">
      ...
      <div className="w-full max-w-md relative z-10">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold tracking-tight">ICT Trading</h1>
          <p className="text-muted-foreground text-sm mt-1">Interface de trading professionnelle</p>
        </div>
        ...
        <Card className="border-border/50 shadow-xl bg-card/80 backdrop-blur-sm">
          <CardHeader className="space-y-1 pb-4">
            ...
            <CardDescription>
              Entrez vos identifiants pour accéder à l&apos;interface
            </CardDescription>
          </CardHeader>
